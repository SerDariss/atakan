...
class GuidencePage1 extends StatefulWidget {
  @override
  _GuidencePage1 createState() => _GuidencePage1();
}

class _GuidencePage1 extends State<GuidencePage1> {
  @override
                  ...
                  Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("PERSONAL TRAINER'A DANIŞ", style: TextStyle(color: Colors.white, fontSize: 20.0),),
                        ),
                      ]
                  ),
                ],
...
class _BottomSheetWidgetState extends State<BottomSheetWidget> {
  ...
  Widget build(BuildContext context) => ListView(
      children: [
        Container(
          margin: EdgeInsets.only(left:0, bottom:0, right:0, top:165),
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Personal Trainer", style: TextStyle(color: Colors.grey, fontSize: 15.0),),
                  ),
                ],
              ),
              Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Padding(
                    padding: EdgeInsets.only(left: 15, bottom:20, right:0, top:50),
                    child:Container(
                      height: 60.0,
                      width: 210.0,
                      decoration: BoxDecoration(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 20, bottom:20, right:15, top: 50),
                    child:Container(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:0, bottom:20, right:0, top: 50),
                    child:Container(
                        child: GestureDetector(
                          onTap: (){
                            Get.to;
